              ...
              <div className="col-6">
                ...
                {districtsList != null ? (
                  ...
                  <table style={{ border: "2px solid", marginTop: "40px" }}>
                    ...
                    <thead>
                      <tr>
                        <th style={{ border: "5px solid", borderRadius:"32px",padding:"10px",margin:"10px",color:"red"}}>S.No</th>
                        <th style={{ border: "5px solid", borderRadius:"32px",padding:"10px",margin:"10px",color:"red"}}>DISTRICT</th>
                        <th style={{ border: "5px solid", borderRadius:"32px",padding:"10px",margin:"10px",color:"red"}}>CONTUENCY</th>
                        <th colSpan={2} style={{ border: "5px solid",borderRadius:"32px",padding:"10px",margin:"10px",color:"red" }}>
                          Manage
                        </th>
                      </tr>
                    </thead>
                    ...
                    {districtsList.map((d, i) => {
                      return (
                        <tr style={{ border: "2px solid" }}>
                          ...
                          <td key={d.id} style={{ border: "4px solid" }}>
                            {" "}
                            <button
                              type="button"
