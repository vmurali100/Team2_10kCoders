            ...
            <form id="register-form">
              <div className="row">
                <button
                  ...
                  id="login"
                  onClick={() => {
                    document.getElementById("login-input").style.display =
                      "block";
                    document.getElementById("signup-input").style.display =
                      "none";
                ...
                <div className="row">
                  <div className="col-5">
                    ...
                    <button
                      ...
                      onClick={() =>
                        UserLogInFunc(user, () => navigate("content"))
                      }
                    >
                      Log in
                    </button>
              ...
              <div id="signup-input" style={{ display: "none" }}>
                <div class="mb-3">
                  <input
                    ...
                    placeholder="*Email"
                    name="email"
                    value={userRegi.email}
                    onChange={(e) => handleChangeregi(e)}
                  />
                </div>
                <div class="mb-3">
                  <input
                ...
                <div class="mb-3">
                  <input
                    ...
                    value={userRegi.confirmPassword}
                    onChange={(e) => handleChangeregi(e)}
                  />
                </div>
                <div class="mb-3">
