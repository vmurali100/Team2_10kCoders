...
import "./App.css";
import Navbar, { ContactHeader, Footer } from "./Components/Navbar";
...
import Header from "./Components/EntryPage";
    ...
    <div className="App">
      <BrowserRouter>
        ...
        <Routes>
          <Route
            path="register"
            element={loggeduser != null ? "" : <Register />}
          />
          <Route
            path=""
            element={loggeduser != null ? <Header /> && <Home /> : <Home />}
          />
