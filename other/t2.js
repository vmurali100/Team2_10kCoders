...
s.appendChild(simg)
simg.setAttribute("src", "./template_images/" + 960 + "x" + 360 + ".gif")
...
for (i = 0; i < allImages.length; i++) {
    ...
    imgElm.setAttribute("src", "./template_images/83/" + 32 + "x" + 32 + ".gif")
    allImages[i].appendChild(imgElm)
}
...
for (i = 0; i < allImages.length; i++) {
    ...
    imgElm.style.width = "100%"
    var imgNum = Number(i) + 1
    imgElm.setAttribute("src", "./images/" + imgNum + "image1.jpg")
    allImages[i].appendChild(imgElm)
}
...
flr.target = "_blank"
fl2.title = ""
fl2.innerHTML = "templates by " + " " + flr.innerHTML
fl2.appendChild(flr)
