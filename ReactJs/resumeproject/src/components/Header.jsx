                ...
                <div className="container"><a className="navbar-brand" href="index.html">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav ms-auto">
                            {navlinks.map((nav)=>
                         <li className="nav-item"><a className="nav-link text-uppercase" ><Link to={`/${nav}`}>{nav}</Link></a></li>
                        ...
                        {/* <ul className="navbar-nav ms-auto">
                            ...
                            <li className="nav-item"><a className="nav-link text-uppercase" ><Link to="/about">About</Link></a></li>
                            <li className="nav-item"><a className="nav-link text-uppercase" ><Link to="/expertise">Expertise</Link></a></li>
                            <li className="nav-item"><a className="nav-link text-uppercase" ><Link to="/education">Education</Link></a></li>
                            <li className="nav-item"><a className="nav-link text-uppercase" ><Link to="/experience">Experience</Link></a></li>
                            <li className="nav-item"><a className="nav-link text-uppercase" ><Link to="/contact">Contact</Link></a></li>
                        </ul> */}
                    </div>
                </div>
            </nav>
