...
const Login = (props)=>{
 ...
 const navigate = useNavigate()
  const handlechange = (e)=>{
    ...
    return <div>
        {console.log(user)}
        <div className="container" style={{"marginTop" : "80px",backgroundColor:"pink",width:"700px"}}> 
            <div className="row">
  ...
  <button type="button" class="btn btn-primary" onClick={()=>props.logInUserFunc(user , ()=> navigate("/register") ,()=> navigate("/") )}>Log In</button> <br />
   Don't Have Account ?   <button type="button" class="btn btn-warning" onClick={()=> navigate("/register")}>Register</button>
</form> 
 <br />
